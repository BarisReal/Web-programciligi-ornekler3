...
?>
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="images/demo/slider/1.png" alt=""></a>
        <figcaption>
          <h2>Uygulama 2</h2>
<?php
...
echo createTable($data);
  ?>
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/1.png" alt=""></a>
        <figcaption>
          <h2>uygulama3</h2>
         <?php
...
?>
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="images/demo/slider/1.png" alt=""></a>
        <figcaption>
          <h2>Uygulama 3</h2>
          <?php 
 $turkLirasi=3000;
...
?>
      ...
      <figure id="slide-5"><a class="view" href="#"><img src="images/demo/slider/1.png" alt=""></a>
        <figcaption>
